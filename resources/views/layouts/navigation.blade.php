<div class="bg-white border-0 shadow-xs nav-header">
    ...
    <div class="nav-top">
        <a href="{{url("/")}}"><i class=" text-success display1-size me-2 ms-0" style="margin-top: -10px">{!! $icons->getIcon("zap")  !!}</i><span
                class="mb-0 text-current d-inline-block fredoka-font ls-3 fw-600 font-xxl logo-text">{{config("app.name")}} </span>
        </a>
    ...
    <a href="#" class="p-2 text-center ms-0 menu-icon center-menu-icon"><i
            class=" font-lg bg-greylight btn-round-lg theme-dark-bg text-grey-500" style="margin-top: -10px">{!! $icons->getIcon("zap")  !!}</i></a>
    <a href="#" class="p-2 text-center ms-0 menu-icon center-menu-icon"><i
            class=" font-lg bg-greylight btn-round-lg theme-dark-bg text-grey-500" style="margin-top: -10px">{!! $icons->getIcon("video")  !!}</i></a>
    <a href="#" class="p-2 text-center ms-0 menu-icon center-menu-icon"><i
            class=" font-lg bg-greylight btn-round-lg theme-dark-bg text-grey-500" style="margin-top: -10px">{!! $icons->getIcon("user")  !!}</i></a>
    ...
    <a href="#" class="p-2 text-center ms-auto menu-icon" id="dropdownMenu3" data-bs-toggle="dropdown"
        aria-expanded="false"><span class="dot-count bg-warning"></span><i
            class="text-current font-xl" style="margin-top: -10px">{!! $icons->getIcon("bell")  !!}</i></a>
    ...
    <a href="#" class="p-2 text-center ms-3 menu-icon chat-active-btn"><i
            class="text-current font-xl" style="margin-top: -10px">{!! $icons->getIcon("message-circle")  !!}</i></a>
