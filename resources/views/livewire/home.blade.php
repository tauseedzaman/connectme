                        ...
                        <div class="overflow-hidden owl-carousel category-card owl-theme nav-none">
                            <div class="item">
                                <div data-bs-toggle="modal" data-bs-target="#Modalstory"
                                    class="mt-3 mb-3 overflow-hidden border-0 shadow-none card w125 h200 d-block rounded-xxxl bg-dark">
                                    <div class="bottom-0 p-3 text-center card-body d-block w-100 position-absolute">
                                        <a href="#">
                                            ...
                                            <h4
                                                class="mt-2 mb-1 text-white fw-700 position-relative z-index-1 ls-1 font-xssss">
                                                Add Story </h4>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div data-bs-toggle="modal" data-bs-target="#Modalstory"
                                    ...
                                    <div class="bottom-0 p-3 text-center card-body d-block w-100 position-absolute">
                                        <a href="#">
                                            ...
                                            <div class="clearfix"></div>
                                            <h4
                                                class="mt-2 mb-1 text-white fw-600 position-relative z-index-1 ls-1 font-xssss">
                                                Victor Exrixon </h4>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="item">
                                <div data-bs-toggle="modal" data-bs-target="#Modalstory"
                                    class="mt-3 mb-3 overflow-hidden border-0 cursor-pointer card w125 h200 d-block shadow-xss rounded-xxxl bg-gradiant-bottom me-1">
                                    <video autoplay loop class="float-right w-100">
                            ...
                            <div class="item">
                                <div data-bs-toggle="modal" data-bs-target="#Modalstory"
                                    ...
                                    <div class="bottom-0 p-3 text-center card-body d-block w-100 position-absolute">
                                        <a href="#">
                                            <figure
                                                class="mb-0 avatar ms-auto me-auto position-relative w50 z-index-1">
                ...
                <div class="col-xl-4 col-xxl-3 col-lg-4 ps-lg-0">
                    <div class="mb-3 border-0 card w-100 shadow-xss rounded-xxl">
                        ...
                        <div class="pt-4 pb-0 card-body d-flex ps-4 pe-4 border-top-xs bor-0">
                            <figure class="avatar me-3"><img src="images/user-7.png" alt="image"
                                    class="shadow-sm rounded-circle w45"></figure>
                            <h4 class="mt-1 fw-700 text-grey-900 font-xssss">Anthony Daugloi <span
                        ...
                        <div class="pt-0 pb-4 card-body d-flex align-items-center ps-4 pe-4">
                            <a href="#"
                                class="p-2 text-center text-white lh-20 w100 bg-primary-gradiant me-2 font-xssss fw-600 ls-1 rounded-xl">Confirm</a>
                            <a href="#"
                                class="p-2 text-center lh-20 w100 bg-grey text-grey-800 font-xssss fw-600 ls-1 rounded-xl">Delete</a>
                        </div>

                        <div class="pt-0 pb-0 card-body d-flex ps-4 pe-4">
                            <figure class="avatar me-3"><img src="images/user-8.png" alt="image"
                                    class="shadow-sm rounded-circle w45"></figure>
                            <h4 class="mt-1 fw-700 text-grey-900 font-xssss">Mohannad Zitoun <span
                                    class="mt-1 d-block font-xssss fw-500 lh-3 text-grey-500">12 mutual friends</span>
                            </h4>
                        </div>
                        <div class="pt-0 pb-4 card-body d-flex align-items-center ps-4 pe-4">
                        ...
                        <div class="pt-0 pb-4 card-body dd-block ps-4 pe-4">
                            <ul class="mt-1 mb-2 memberlist ms-0 d-block">
                                ...
                                <li class="last-member"><a href="#"
                                        class="text-center bg-greylight fw-600 text-grey-500 font-xssss w35 ls-3"
                                        style="height: 35px; line-height: 35px;">+2</a></li>
                                <li class="w-auto ps-3 ms-1"><a href="#"
